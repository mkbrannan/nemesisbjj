...
get_header(); // This fxn gets the header.php file and renders it ?>
	<div id="primary" class="row-fluid">
		...
		<!--<div class="bkg-img home"> <?php echo get_the_post_thumbnail( $post_id, $size, $attr ); ?> </div>	-->
		<?php $thumb = wp_get_attachment_image_src( get_post_thumbnail_id($post->ID), 'full' );?>
		<div id="content" role="main" class="holder full-background home" style="background-image: url('<?php echo $thumb['0'];?>')" >
			<?php if ( have_posts() ) : 
